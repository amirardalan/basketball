...
const light = '#f8f8f8'
const lightAccent = '#f3f3f3'
const lightDarker = '#f0f0f0'
const dark = '#353535'
const darkAccent = '#3f3f3f'
const darker = '#1a1a1a'
const primary = '#c40000'
const secondary = '#f8f8f8'
const grayLight = '#b0bccc'
const grayDark = '#606071'
const grayAccentLight = '#cccccc'
const grayAccentDark = '#5c5c5c'
const buttonDisabled = '#b9b9b9'
const warning = '#e64358'
const codeHighlight = '#4e4e4e'
const avatar = '#888888'
